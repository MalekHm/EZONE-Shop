...
<script>
    (function ($) {
        ...
        $('body').on('click', '.media-uploader-image-list > li', function (e) {
            ...
            $('.img_alt_submit_btn').html('<i class="<?php if($type === 'admin'): ?> las la-check <?php else: ?> las la-check <?php endif; ?>"></i>');
        ...
        $(document).on('click', '.img_alt_submit_btn', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('.img_alt_submit_btn').html('<i class="<?php if($type === 'admin'): ?> las la-check-circle <?php else: ?>  las la-check-circle  <?php endif; ?>"></i>');
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\media\old\js.blade.php ENDPATH**/ ?>