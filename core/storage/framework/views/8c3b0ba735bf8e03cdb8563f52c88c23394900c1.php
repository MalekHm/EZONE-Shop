                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blog-category-create')): ?>
                                <div class="btn-wrapper">
                                    <a data-bs-toggle="modal" data-bs-target="#new_category_modal"
                                        class="cmn_btn btn_bg_profile pull-right"><?php echo e(__('New Category')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php endif; ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('blog-category-edit')): ?>
                                                    <a href="#1" data-bs-toggle="modal" data-bs-target="#category_edit_modal"
                                                        ...
                                                        data-lang="<?php echo e($data->lang); ?>" data-status="<?php echo e($data->status); ?>">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                <?php endif; ?>
                                            </td>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\blog\category.blade.php ENDPATH**/ ?>