                ...
                $('body').on('click', '.widget_save_change_button', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data === 'ok') {
                                form.append(
                                    '<span class="text-success"><?php echo e(__('data saved success')); ?></span>'
                                );
                            }
                            setTimeout(function() {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\page-builder\contactpage.blade.php ENDPATH**/ ?>