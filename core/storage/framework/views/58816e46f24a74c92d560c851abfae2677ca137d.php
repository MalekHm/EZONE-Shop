...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__body">
                        <h4 class="dashboard__card__title"><?php echo e(__('Order Form Builder')); ?></h4>
                        <div class="alert alert-danger alert-block ">
                            <strong><i class="ti-hand-point-right mr-1"></i>
                                <?php echo e(__("Note: Please, don't add Name & Email Form Fields here!")); ?></strong>
                        </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\form-builder\order-form.blade.php ENDPATH**/ ?>