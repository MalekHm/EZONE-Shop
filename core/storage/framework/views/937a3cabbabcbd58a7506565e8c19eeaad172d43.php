...
<div class="slick-slider-items wow fadeInUp" data-wow-delay=".<?php echo e($loop->iteration); ?>s">
    <div class="global-card-item radius-10">
        ...
        <div class="global-card-contents">
            <h4 class="common-title-two hover-color-two"><a href="<?php echo e(route("frontend.products.single",$product->slug)); ?>"> <?php echo e($product->name); ?></a></h4>
            <div class="global-card-flex-contents">
                <div class="single-global-card">
                    <div class="global-card-left <?php echo e($product->reviews_avg_rating < 1 ? "d-none" : ""); ?>">
                    ...
                    <div class="global-card-right">
                        <a href="<?php echo e(route("frontend.products.single",$product->slug)); ?>" class="stock-available color-stock"> Stock(<?php echo e($stock_count); ?>) </a>
                    </div>
                </div>
                <div class="single-global-card mt-2">
                    <div class="global-card-left">
                        <div class="price-update-through">
                            <span class="fs-24 fw-500 ff-rubik flash-prices color-two"> <?php echo e(float_amount_with_currency_symbol(calculatePrice($sale_price, $product))); ?> </span>
                            <span class="fs-18 flash-old-prices ff-rubik"> <?php echo e(float_amount_with_currency_symbol(calculatePrice($deleted_price, $product))); ?> </span>
                        </div>
                    </div>
                    <div class="global-card-right">
...
</div><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/Product\Resources/views/components/frontend/grid-style-01.blade.php ENDPATH**/ ?>