            ...
            <div class="col-lg-6">
                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Contact Form Builder')); ?></h4>
                    </div>
                    <div class="dashboard__card__body custom__form mt-4">
                        <form action="<?php echo e(route('admin.form.builder.contact')); ?>" method="Post">
                            ...
                            <button type="submit" class="cmn_btn btn_bg_profile"
                                id="update"><?php echo e(__('Save Change')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\form-builder\contact-form.blade.php ENDPATH**/ ?>