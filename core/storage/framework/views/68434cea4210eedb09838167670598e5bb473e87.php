...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('All Tickets')); ?></h4>
...
<?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('support-ticket-create')): ?>
                                <div class="btn-wrapper d-flex">
                                    <a href="<?php echo e(route('admin.support.ticket.new')); ?>"
                                        class="cmn_btn btn_bg_profile"><?php echo e(__('New Ticket')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php endif; ?>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="<?php echo e($data->priority); ?> dropdown-toggle"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('support-ticket-priority-change')): ?>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item change_priority"
                                                                data-id="<?php echo e($data->id); ?>" data-val="low"
                                                                href="#1"><?php echo e(__('Low')); ?></a>
                                                            <a class="dropdown-item change_priority"
                                                                data-id="<?php echo e($data->id); ?>" data-val="high"
                                                                href="#1"><?php echo e(__('High')); ?></a>
                                                            <a class="dropdown-item change_priority"
                                                                data-id="<?php echo e($data->id); ?>" data-val="medium"
                                                                href="#1"><?php echo e(__('Medium')); ?></a>
                                                            <a class="dropdown-item change_priority"
                                                                data-id="<?php echo e($data->id); ?>" data-val="urgent"
                                                                href="#1"><?php echo e(__('Urgent')); ?></a>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button"
                                                        class="status-<?php echo e($data->status); ?> dropdown-toggle"
                                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('support-ticket-status-change')): ?>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item status_change"
                                                                data-id="<?php echo e($data->id); ?>" data-val="open"
                                                                href="#1"><?php echo e(__('Open')); ?></a>
                                                            <a class="dropdown-item status_change"
                                                                data-id="<?php echo e($data->id); ?>" data-val="close"
                                                                href="#1"><?php echo e(__('Close')); ?></a>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
...
<?php $__env->startSection('script'); ?>
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.js','data' => ['route' => route('admin.support.ticket.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\support-ticket\all-tickets.blade.php ENDPATH**/ ?>