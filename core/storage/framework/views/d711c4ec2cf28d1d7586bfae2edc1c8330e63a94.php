                ...
                <div class="recent-order-wrapper dashboard-table bg-white padding-30">
                    ...
                    <?php $__currentLoopData = $pluginList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plugin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="plugin-card">
                            ...
                            <?php if((\Illuminate\Support\Str::slug($plugin->category,null,"_")) != "coreplugin"): ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/PluginManage\Resources/views/plugin-manage/index.blade.php ENDPATH**/ ?>