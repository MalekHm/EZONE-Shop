            ...
            <div class="col-12">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Edit Admin')); ?></h4>
                        <div class="btn-wrapper">
                            <a class="cmn_btn btn_bg_profile" href="<?php echo e(route('admin.all.user')); ?>"><?php echo e(__('All Admin')); ?></a>
                        </div>
                    </div>
                    <div class="dashboard__card__body custom__form mt-4">
                        ...
                        <form action="<?php echo e(route('admin.user.update')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($admin->email); ?>" name="email"
                                ...
                                <select name="role" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($role); ?>"
                                            <?php if(in_array($role, $adminRole)): ?> selected <?php endif; ?>><?php echo e($role); ?></option>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\admin-role-manage\edit-user.blade.php ENDPATH**/ ?>