            ...
            <div class="col-lg-12">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Media Images')); ?></h4>
                        <a href="#1" class="cmn_btn btn_bg_profile" data-bs-toggle="modal"
                            data-bs-target="#media_image_upload_modal"><?php echo e(__('Add New Image')); ?></a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-xxl-10 col-xl-9 col-lg-9">
                                <ul class="media-uploader-image-list media-page">
                                    <?php $__currentLoopData = $all_media_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li data-date="<?php echo e($image->updated_at); ?>" data-imgid="<?php echo e($image->id); ?>"
                                            data-imgsrc="<?php echo e(asset('assets/uploads/media-uploader/' . $image->path)); ?>"
                                            data-size="<?php echo e($image->size); ?>" data-dimension="<?php echo e($image->dimensions); ?>"
                                            data-title="<?php echo e($image->title); ?>" data-alt="<?php echo e($image->alt); ?>">
                                                ...
                                                <li class="imgalt">
                                                    <div class="img-alt-wrap">
                                                        <input type="text" name="img_alt_tag"
                                                            placeholder="<?php echo e(__('image alt tag')); ?>">
                                                        <button class="btn btn-success img_alt_submit_btn"><i
                                                                class="ti-check"></i></button>
                                                    </div>
                                                </li>
                                            </ul>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('media-upload-delete')): ?>
                                                <form method="post" action="<?php echo e(route('admin.upload.media.file.delete')); ?>"
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    ...
                    <div class="dropzone-form-wrapper">
                        <form action="<?php echo e(route('admin.upload.media.file')); ?>" method="post" class="dropzone"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views/backend/media-images/media-images.blade.php ENDPATH**/ ?>