    ...
    <div class="product-content">
        <div class="main-content">
            ...
            <div class="btn-wrapper">
                ...
                <?php else: ?>
                    <a href="#1" data-attributes="<?php echo e($product->attributes); ?>" data-id="<?php echo e($product->id); ?>" class="add-cart-style-02 add_to_cart_ajax_with_quantity"><?php echo e(__('Add to Bag')); ?></a>
                    <a href="#1" data-attributes="<?php echo e($product->attributes); ?>" data-id="<?php echo e($product->id); ?>" class="favourite add_to_wishlist_ajax">
                        <i class="las la-heart icon hover"></i>
                        <i class="lar la-heart icon regular"></i>
                    </a>
                <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\frontend\product\product-card-02.blade.php ENDPATH**/ ?>