...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.media-upload','data' => ['title' => __('Attribute Image'),'id' => $image_id,'name' => 'item_image[]','dimentions' => '1280x1280']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\product\variant-info\repeater.blade.php ENDPATH**/ ?>