                            ...
                            <div class="payment-contents">
                                ...
                                <ul class="payment-list payment-list-two margin-top-30">
                                    ...
                                    <li>
                                        ...
                                        <span class="payment-list-right payment-bold">
                                            <?php echo e($payment_details->payment_status); ?></span>
                                    </li>
                                    <li>
                                        <span class="payment-list-left list-bold"><?php echo e(__('Order Status:')); ?> </span>
                                        <span class="payment-list-right payment-bold">
                                            <?php echo e($payment_details->order_status); ?></span>
                                    </li>
                                    <li>
                                        <span class="payment-list-left list-bold"><?php echo e(__('Order Track:')); ?> </span>
                                        <span class="payment-list-right payment-bold"> <?php echo e($orderTrack->name); ?></span>
                                    </li>
                                    <li>
...
<?php echo $__env->make('frontend.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\user\dashboard\order\details.blade.php ENDPATH**/ ?>