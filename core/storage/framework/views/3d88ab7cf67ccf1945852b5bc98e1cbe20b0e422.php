        ...
        <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wishlist_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <li class="single-cart-item">
                ...
                <div class="second-content">
                    ...
                    <div class="del-icon">
                        <a href="#1" class="remove_wishlist_item" data-id="<?php echo e($wishlist_item['id']); ?>" data-attr="<?php echo e(json_encode($wishlist_item['attributes'])); ?>">
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\partials\mini-wishlist.blade.php ENDPATH**/ ?>