            ...
            <div class="col-lg-12">
                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Edit Service')); ?></h4>
                    </div>
                        ...
                        <form action="<?php echo e(route('admin.services.update')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="lang" id="language" class="form-control">
                                    <?php $__currentLoopData = get_all_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($language->slug == $service->lang): ?> selected <?php endif; ?>
                                            value="<?php echo e($language->slug); ?>"><?php echo e($language->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="icon_type" class="form-control" id="edit_icon_type">
                                    <option <?php if($service->icon_type == 'icon'): ?> selected <?php endif; ?> value="icon">
                                        <?php echo e(__('Font Icon')); ?></option>
                                    <option <?php if($service->icon_type == 'image'): ?> selected <?php endif; ?> value="image">
                                        <?php echo e(__('Image Icon')); ?></option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group ">
                                    ...
                                    <button type="button" class="icp icp-dd btn btn-primary dropdown-toggle"
                                        data-selected="<?php echo e($service->icon); ?>" data-bs-toggle="dropdown">
                                        <span class="caret"></span>
                                        <span class="sr-only">Toggle Dropdown</span>
                                    </button>
                                    <div class="dropdown-menu"></div>
                                </div>
                                <input type="hidden" class="form-control" id="icon" value="<?php echo e($service->icon); ?>"
                                    name="icon">
                            </div>
                            <div class="form-group">
                                                ...
                                                <div class="thumbnail">
                                                    <div class="centered">
                                                        <img class="avatar user-thumb"
                                                            src="<?php echo e($service_section_img['img_url']); ?>" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <small
                                    class="info-text"><?php echo e(__('it will show in home pages service item short details.')); ?></small>
                            </div>
                            <div class="form-group">
                                <label for="meta_tags"><?php echo e(__('Meta Tags')); ?></label>
                                <input type="text" name="meta_tags" class="form-control"
                                    value="<?php echo e($service->meta_tag); ?>" data-role="tagsinput" id="meta_tags">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="categories_id" id="category" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $service_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php if($service->categories_id == $data->id): ?> selected <?php endif; ?>
                                ...
                                <select name="price_plan[]" multiple class="form-control wide">
                                    ...
                                    <?php $__currentLoopData = $price_plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($data->id); ?>"
                                            <?php if(is_array($select_plan) && in_array($data->id, $select_plan)): ?> selected <?php endif; ?>><?php echo e($data->title); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option <?php if($service->status == 'publish'): ?> selected <?php endif; ?> value="publish">
                                        <?php echo e(__('Publish')); ?></option>
                                    <option <?php if($service->status == 'draft'): ?> selected <?php endif; ?> value="draft">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sr_order" name="sr_order"
                                    value="<?php echo e($service->sr_order); ?>">
                                <span
                            ...
                            <button type="submit" class="cmn_btn btn_bg_profile"><?php echo e(__('Update Service')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\pages\service\edit-service.blade.php ENDPATH**/ ?>