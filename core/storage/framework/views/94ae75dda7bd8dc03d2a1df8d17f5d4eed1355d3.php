...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Update Vendor')); ?></h4>
                    </div>
                    <div class="dashboard__card__body custom__form mt-4">
                        <form id="vendor-create-form" data-action-url="<?php echo e(route('admin.vendor.edit', $vendor->id)); ?>">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="basic-info" aria-selected="true"><?php echo e(__('Basic')); ?>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                            ...
                                            aria-selected="false"><?php echo e(__('Address')); ?>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="shop-info" aria-selected="false"><?php echo e(__('Shop Info')); ?>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="bank-info" aria-selected="false"><?php echo e(__('Bank Info')); ?>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="basic-info" role="tabpanel"
                                    ...
                                    <div class="row g-4 mt-1">
                                        <div class="col-lg-6">
                                            <div class="dashboard__card">
                                                <h4 class="dashboard__card__title"> <?php echo e(__('Basic Info*')); ?> </h4>
                                                <div class="dashboard__card__body custom__form mt-4 single-reg-form">

                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Owner Name')); ?>

                                                        </label>
                                                        <input name="owner_name" type="text"
                                                            class="form--control radius-10"
                                                            value="<?php echo e($vendor->owner_name); ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2">
                                                            <?php echo e(__('Business Name')); ?> </label>
                                                        <input name="business_name" type="text"
                                                            class="form--control radius-10"
                                                            value="<?php echo e($vendor->business_name); ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="username" type="text"
                                                            class="form--control radius-10"
                                                            value="<?php echo e($vendor->username); ?>">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2">
                                                            <?php echo e(__('Business Category')); ?> </label>
                                        ...
                                        <div class="col-lg-6">
                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.media.media-upload','data' => ['oldImage' => $vendor?->vendor_shop_info?->logo,'title' => __('Logo'),'name' => 'logo_id','dimentions' => '200x200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['old-image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($vendor?->vendor_shop_info?->logo),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Logo')),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('logo_id'),'dimentions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('200x200')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['old-image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($vendor?->vendor_shop_info?->cover_photo),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Cover Photo')),'name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('cover_photo_id'),'dimentions' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('200x200')]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="dashboard__card">
                                                ...
                                                <div class="dashboard__card__body custom__form mt-4 single-reg-form">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Country')); ?>
                                                    ...
                                                    ?>
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('State')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('City')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Zip Code')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Address')); ?>

                                                        </label>
                                                        <textarea name="address" type="text" class="form--control radius-10"
                                                            value="<?php echo e($vendor?->vendor_address?->address); ?>"></textarea>
                                                    </div>
                                    ...
                                    <div class="row g-4 mt-1">
                                        <div class="col-lg-12">
                                            <div class="dashboard__card">
                                                ...
                                                <div class="dashboard__card__body custom__form mt-4 single-reg-form">
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Location')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Number')); ?>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2">
                                                            <?php echo e(__('Email Address')); ?> </label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Website')); ?>
                                ...
                                <div class="tab-pane fade" id="bank-info" role="tabpanel" aria-labelledby="contact-tab">
                                    <div class="row g-4 mt-1">
                                        <div class="col-lg-12">
                                            <div class="dashboard__card">
                                                <h4 class="dashboard__card__title"> <?php echo e(__('Bank Info')); ?> </h4>
                                                <div class="dashboard__card__body custom__form mt-4 single-reg-form">
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Name')); ?>

                                                        </label>
                                                        <input value="<?php echo e($vendor?->vendor_bank_info?->bank_name); ?>"
                                                            name="bank_name" type="text"
                                                            class="form--control radius-10"
                                                            placeholder="<?php echo e(__('Type Name')); ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Email')); ?>

                                                        </label>
                                                        <input value="<?php echo e($vendor?->vendor_bank_info?->bank_email); ?>"
                                                            name="bank_email" type="text"
                                                            class="form--control radius-10" placeholder="Type Email">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="label-title color-light mb-2"> <?php echo e(__('Bank Code')); ?>

                                                        </label>
                                                        <input value="<?php echo e($vendor?->vendor_bank_info?->bank_code); ?>"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value="<?php echo e($vendor?->vendor_bank_info?->account_number); ?>"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/Vendor\Resources/views/backend/edit.blade.php ENDPATH**/ ?>