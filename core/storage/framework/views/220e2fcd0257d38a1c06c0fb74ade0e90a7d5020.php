...
<div class="col wow fadeInUp" data-wow-delay=".<?php echo e($loop->iteration); ?>s">
    <div class="product_card">
        <div class="product_card__thumb">
            <a href="<?php echo e(route('frontend.products.single', $product->slug)); ?>" class="product_card__thumb__bgImg">
...
<?php endif; ?>
        ...
        <div class="product_card__contents">
            <h5 class="product_card__title"> <a
                    href="<?php echo e(route('frontend.products.single', $product->slug)); ?>"><?php echo e($product->name); ?> </a> </h5>
            <h4 class="product_card__price mt-2">
                <?php echo e(float_amount_with_currency_symbol(calculatePrice($sale_price, $product))); ?>

                <s><?php echo e(float_amount_with_currency_symbol(calculatePrice($deleted_price, $product))); ?></s></h4>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/Product\Resources/views/components/frontend/campaign-grid-style-02.blade.php ENDPATH**/ ?>