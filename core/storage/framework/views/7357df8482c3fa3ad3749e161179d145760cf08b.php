                ...
                <div class="col-lg-8">
                    <div class="support-ticket-wrapper">
                        <?php if(auth()->guard('web')->check()): ?>
                            <h3 class="title">
                                <?php echo e(get_static_option('support_ticket_' . $user_select_lang_slug . '_form_title')); ?></h3>
...
<?php endif; ?>
                            <form action="<?php echo e(route('frontend.support.ticket.store')); ?>" method="post"
                                ...
                                <div class="btn-wrapper text-center">
                                    <button
                                        type="submit"><?php echo e(get_static_option('support_ticket_' . $user_select_lang_slug . '_button_text')); ?></button>
                                </div>
                            </form>
                        <?php else: ?>
                            <?php echo $__env->make('frontend.partials.ajax-login-form',['title' =>
                            get_static_option('support_ticket_'.$user_select_lang_slug.'_login_notice')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\support-ticket\support-ticket.blade.php ENDPATH**/ ?>