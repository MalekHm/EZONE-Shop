...
<div class="d-flex">
    ...
    <div class="btn-wrapper">
        <a href="#1" data-attributes="<?php echo e($product->attributes); ?>" data-id="<?php echo e($product->id); ?>" class="btn-default rounded-btn add-cart-style-02 add_to_cart_ajax">
            <?php echo e(__('add to cart')); ?>

        </a>

        <a href="#1" data-attributes="<?php echo e($product->attributes); ?>" data-id="<?php echo e($product->id); ?>" class="btn-default rounded-btn add-cart-style-02 buy_now_single_quick_view_btn">
            <?php echo e(__('Buy now')); ?>

        </a>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\partials\product-attributes.blade.php ENDPATH**/ ?>