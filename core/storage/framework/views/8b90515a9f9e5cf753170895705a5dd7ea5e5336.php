                ...
                <div class="dashboard__card__header__right">
                    ...
                    <div class="bulk-delete-wrapper">
                        <div class="select-box-wrap">
                            ...
                            <button class="cmn_btn btn_bg_profile" id="bulk_delete_btn"><?php echo e(__('Apply')); ?></button>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\frontend-user\all-user.blade.php ENDPATH**/ ?>