                                ...
                                <div class="single-shop-details-wrapper">
                                    ...
                                    <div class="price-update-through mt-4">
                                        <h3 class="ff-rubik flash-prices color-one price"
                                            ...
                                            id="quick-view-price"> <?php echo e(amount_with_currency_symbol(calculatePrice($sale_price, $product))); ?> </h3>
                                        <span class="fs-22 flash-old-prices" id="deleted_price" data-deleted-price="<?php echo e(calculatePrice($deleted_price, $product)); ?>"> <?php echo e(amount_with_currency_symbol(calculatePrice($deleted_price, $product))); ?> </span>
                                    </div>
                                    ...
                                    <div class="wishlist-compare">
                                        <div class="wishlist-compare-btn mt-4">
                                            <a href="#1" data-id="<?php echo e($product->id); ?>" class="btn-wishlist buy_now_single_page_quick_view btn-details btn-buyNow"> <i class="lar la-cart-arrow-down"></i> <?php echo e(__("Buy now")); ?> </a>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\product\quick-view.blade.php ENDPATH**/ ?>