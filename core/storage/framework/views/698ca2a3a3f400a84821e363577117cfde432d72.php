            ...
            <div class="col-lg-12">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Create Vendor')); ?></h4>
                    </div>
                    <div class="dashboard__card__body custom__form mt-4">
                        <form id="vendor-create-form" data-action-url="<?php echo e(route('admin.vendor.create')); ?>">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="basic-info" role="tabpanel"
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="row g-4">
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Owner Name")); ?> </label>
                                                                <input name="owner_name" type="text"
                                                                    class="form--control radius-10"
                                                                    placeholder="<?php echo e(__("Owner Name")); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Business Name")); ?> </label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                ...
                                                                <input name="email" type="text"
                                                                    class="form--control radius-10" placeholder="<?php echo e(__("Email")); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Username")); ?></label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Password")); ?></label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"><?php echo e(__("Confirmed Password")); ?></label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Business
                                                                    Category")); ?> </label>
                                        ...
                                        <div class="col-lg-6">
                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.media-upload','data' => ['title' => __('Logo'),'name' => 'logo_id','dimentions' => '200x200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Logo')),'name' => 'logo_id','dimentions' => '200x200']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.media-upload','data' => ['title' => __('Cover Photo'),'name' => 'cover_photo_id','dimentions' => '200x200']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('media-upload'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Cover Photo')),'name' => 'cover_photo_id','dimentions' => '200x200']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
                                            ...
                                            <div class="dashboard__card">
                                                ...
                                                <div class="dashboard__card__body mt-4">
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Email Address")); ?> </label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Website")); ?> </label>
                                            ...
                                            <div class="dashboard__card">
                                                ...
                                                <div class="dashboard__card__body mt-4">
                                                    <div class="row g-4">
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Name")); ?> </label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Bank Code")); ?> </label>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="single-input">
                                                                <label class="label-title"> <?php echo e(__("Account Number")); ?>

                                                                </label>
                                                                <input name="account_number" type="tel"
                                                                    class="form--control radius-10"
                                                                    placeholder="<?php echo e(__("Type Account Number")); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/Vendor\Resources/views/backend/create.blade.php ENDPATH**/ ?>