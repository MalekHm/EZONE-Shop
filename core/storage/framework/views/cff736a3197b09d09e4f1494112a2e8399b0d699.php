<div class="form-group">
    ...
    <div class="btn-group <?php echo e($id); ?>">
        ...
        <button type="button" class="icp icp-dd btn bt-xl btn-info dropdown-toggle"
                data-selected="<?php echo e((isset($value))? get_static_option($value) : (($setval)??'fas fa-phone')); ?>" data-bs-toggle="dropdown">
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\add-icon.blade.php ENDPATH**/ ?>