            ...
            <div class="col-lg-7">
                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('All Header Slider')); ?></h4>
...
<?php endif; ?>
                                                <a href="#1" data-bs-toggle="modal"
                                                    ...
                                                    data-imageid="<?php echo e($data->image); ?>" <?php echo render_img_url_data_attr($data->image, 'image'); ?>
            ...
            <div class="col-lg-5">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('New Header Slider')); ?></h4>
                    </div>
                    <div class="dashboard__card__body custom__form mt-4">
                        <form action="<?php echo e(route('admin.header')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control max-height-150" id="description" name="description" placeholder="<?php echo e(__('Description')); ?>"
                            ...
                            <button id="submit" type="submit"
                                class="cmn_btn btn_bg_profile"><?php echo e(__('Add  New Slider')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="header_slider_item_edit_modal" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content custom__form">
                ...
                <form action="<?php echo e(route('admin.header.update')); ?>" id="header_slider_edit_modal_form" method="post"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="media-upload-btn-wrapper">
                                ...
                                <button type="button" class="btn btn-info media_upload_form_btn"
                                    data-btntitle="Select Slider Background" data-modaltitle="Upload Slider Background"
                                    data-imgid="<?php echo e(auth()->user()->image); ?>" data-bs-toggle="modal"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\pages\home\header.blade.php ENDPATH**/ ?>