            ...
            <div class="invoice-details-flex">
                <div class="invoice-single-details">
                    ...
                    <ul class="details-list">
                        ...
                        <li class="list"> <a href="#1"> <?php echo e($order_details->email); ?> </a> </li>
                        <li class="list"> <a href="#1"> <?php echo e($order_details->phone); ?></a> </li>
                    </ul>
                </div>
        ...
        <div class="item-description">
            ...
            <table class="custom--table">
                ...
                <?php $__currentLoopData = $order_details->sale_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e(optional($sale->product)->title); ?> <?php echo e(getItemAttributesName($sale->attributes)); ?></td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if(!empty($order_details->payment_gateway)): ?>
                                    <span class="data-span"> <?php echo e(__('Payment Gateway:')); ?> </span> <?php echo e(ucwords(str_replace("_", " ", $order_details->payment_gateway))); ?>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\partials\checkout\invoice-partial.blade.php ENDPATH**/ ?>