            ...
            <div class="col-12">
                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('RSS Feed Settings')); ?></h4>
                    </div>
                    <div class="dashboard__card__body custom__form mt-4">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('admin.general.rss.feed.settings')); ?>" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="site_rss_feed_url" id="site_rss_feed_url" class="form-control"
                                    value="<?php echo e(get_static_option('site_rss_feed_url')); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="site_rss_feed_title" id="site_rss_feed_title"
                                    class="form-control" value="<?php echo e(get_static_option('site_rss_feed_title')); ?>">
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="site_rss_feed_description" id="site_rss_feed_description" cols="30" rows="5"
                                    class="form-control"><?php echo e(get_static_option('site_rss_feed_description')); ?></textarea>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\general-settings\rss-feed-settings.blade.php ENDPATH**/ ?>