        ...
        $(document).on('click','.media_upload_modal_submit_btn',function (e) {
            ...
            if( typeof allData != 'undefined'){
                ...
                $.each(allData,function(index,value){
                    ...
                    mainUploadBtn.parent().find('.img-wrap').append('<div class="rmv-span"><i class="<?php echo e($trash_icon); ?>"></i></div><div class="attachment-preview"><div class="thumbnail"><div class="centered">'+imageMarkup+'</div></div></div>');
                });
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views/backend/partials/media-upload/js.blade.php ENDPATH**/ ?>