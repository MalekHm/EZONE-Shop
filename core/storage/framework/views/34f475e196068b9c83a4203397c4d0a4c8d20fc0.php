...
<?php endif; ?>
                    <div class="dashboard__card">
                        <div class="dashboard__card__header">
                            <h4 class="dashboard__card__title"><?php echo e(__('404 Error Pagte Settings')); ?></h4>
                        </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="error_404_page_title" class="form-control"
                                                value="<?php echo e(get_static_option('error_404_page_title')); ?>"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.media-upload','data' => ['title' => __('Error image'),'name' => 'error_404_page_image']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\pages\404\404-page-settings.blade.php ENDPATH**/ ?>