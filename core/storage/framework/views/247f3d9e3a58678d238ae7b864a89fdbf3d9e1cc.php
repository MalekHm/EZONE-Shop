            ...
            <div class="global-card-flex-contents">
                <div class="single-global-card">
                    <div class="global-card-left">
                        <span class="stock-available <?php if($stock_count > 0): ?> color-stock <?php else: ?> text-danger <?php endif; ?>">
                            <?php if($stock_count > 0): ?> <?php echo e(__("Stock Available")); ?>(<?php echo e($stock_count); ?>) <?php else: ?> <?php echo e(__("Out of stock")); ?> <?php endif; ?>
                        </span>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/Product\Resources/views/components/frontend/grid-style-03.blade.php ENDPATH**/ ?>