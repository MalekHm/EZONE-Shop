    ...
    <div class="widget widget-search">
        <form class="search-from">
            <div class="form-group">
                <input type="search" id="search_query" class="form-control" autocomplete="off" placeholder="search..."
                    ...
                    <div class="card p-0 border-0 custom-category-list">
                                ...
                                <div class="single-checkbox-wrap">
                                    <label>
                                        <input type="radio" name="product_cat" class="radio"
                                            <?php if(request()->cat == $category->id): ?> checked <?php endif; ?>
                        ...
                        <?php if(optional($category->subcategory)->count() > 0): ?>
                            <div id="collapse-<?php echo e($i); ?>"
                                class="collapse <?php echo e($category->id === $cat ? 'show' : ''); ?>"
                                            ...
                                            <div class="single-checkbox-wrap">
                                                <label>
                                                    <input type="radio" name="product_subcat" class="radio"
                                                        <?php if(request()->subcat == $subcategory->id): ?> checked <?php endif; ?>
    ...
    <div class="widget widget-tag">
        ...
        <div class="tag-wrap">
            <?php $__currentLoopData = $all_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="#1"
                    class="tag-btn <?php if(isset(request()->t) && request()->t == $tag->tag_text): ?> active <?php endif; ?>"><?php echo e($tag->tag_text ?? $tag->tag); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
                ...
                <?php $__currentLoopData = $selected_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $selected_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="single-recent-item">
                        ...
                        <div class="content">
                            <h5 class="title">
                                <a
                                    href="<?php echo e(route('frontend.products.single', $selected_item->slug)); ?>"><?php echo e(Str::limit($selected_item->title, 25)); ?></a>
                            </h5>
                            <span
                                class="product-meta"><?php echo e(float_amount_with_currency_symbol($selected_item->sale_price)); ?>/1kg</span>
                            <div class="ratings">
                                <a href="#1" class="icon-wrap">
            ...
            <div class="add-banner-y-style-01">
                ...
                <div class="content">
                    ...
                    <div class="btn-wrapper">
                        <a href="<?php echo e(url($featured_section_btn_url)); ?>"
                            class="shop-now-btn-style-01"><?php echo e($featured_section_btn_text); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\partials\product\product-filter-sidebar.blade.php ENDPATH**/ ?>