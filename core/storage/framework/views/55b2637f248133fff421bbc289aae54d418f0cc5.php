...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.counter','data' => ['countdownTime' => $campaignProductEndDate]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        ...
        <ul class="other-content">
            <?php if(!empty($product->badge)): ?>
                <li>
                    <span class="badge-tag"><?php echo e($product->badge?->name); ?></span>
                </li>
            <?php endif; ?>
        ...
        <div class="hover-content">
            <ul class="hover-element-list">
                ...
                <?php endif; ?>
                <li>
                    <a href="#1" data-id="<?php echo e($product->id); ?>" class="add_to_compare_ajax">
                ...
                <li>
                    ...
                    <?php else: ?>
                        <a href="#1" class="quick-view" <?php echo getQuickViewDataMarkup($product); ?>>
                            <i class="las la-expand-arrows-alt icon"></i>
                        </a>
                    <?php endif; ?>
                </li>
        ...
        <div class="main-content">
            <div class="ratings">
                <span class="icon-wrap">
                    <?php if($product->rattings_count): ?>)
                        <?php echo ratingMarkup($product->ratings_avg_rating, $product->rattings_count, false); ?>

                    <?php endif; ?>
                </span>
                <?php if($product->rattings_count): ?>
                    <span class="total-feedback">(<?php echo e($product->rattings_count); ?>)</span>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\frontend\product\product-card-03.blade.php ENDPATH**/ ?>