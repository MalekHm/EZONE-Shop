...
<div class="single-product-view-grid-style-01 product_card">
    <div class="product-thumb">
        ...
        <ul class="other-content">
            <?php if(!empty($campaign_percentage)): ?>
                <li>
                    <span class="badge-tag"><?php echo e(round($campaign_percentage,0)); ?>%</span>
                </li>
            <?php endif; ?>
        ...
        <ul class="other-content-2">
            ...
            <?php else: ?>
                <li>
                    <a href="#1" data-id="<?php echo e($product->id); ?>" class="favourite add_to_wishlist_ajax">
                        <i class="las la-heart icon hover"></i>
                        <i class="lar la-heart icon regular"></i>
                    </a>
                </li>
            <?php endif; ?>
            <li>
                <a href="#1" data-id="<?php echo e($product->id); ?>" class="favourite add_to_compare_ajax">
            ...
            <?php else: ?>
                <li>
                    <a href="#1" <?php echo getQuickViewDataMarkup($product); ?> class="favourite quick-view">
                        <i class="lar la-eye icon regular"></i>
                        <i class="lar la-eye icon hover"></i>
                    </a>
                </li>
    ...
    <div class="product-content">
        <div class="main-content">
            ...
            <span class="quantity"><?php echo e($product->uom?->quantity); ?> <?php echo e($product->uom?->unit?->name); ?></span>
        ...
        <div class="hover-content">
            ...
            <div class="btn-wrapper">
                ...
                <?php else: ?>
                    <a href="#1" data-attributes="<?php echo e($product->attributes); ?>" data-id="<?php echo e($product->id); ?>" class="add-cart-style-01 add_to_cart_ajax_with_quantity"><?php echo e(__('Add to Bag')); ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\frontend\product\product-card.blade.php ENDPATH**/ ?>