...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Edit Category Menu')); ?></h4>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('category-menu')): ?>
                            <div class="btn-wrapper">
                                <a href="<?php echo e(route('admin.category.menu.settings')); ?>" class="btn btn-primary btn-xs">
                    ...
                    <div class="dashboard__card__body custom__form mt-4">
                        <form action="<?php echo e(route('admin.category.menu.update', $page_post->id)); ?>" id="menu_update_form"
                                        ...
                                        <div class="accordion accordion-wrapper" id="add_menu_item_accordion">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="custom-links-content" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <p><?php echo e(__("If you want to use root url of your site")); ?> <br>
                                                                <?php echo e(__("For that use this")); ?>
            ...
            $(document).on('click', '.add_mega_menu_to_menu', function(e) {
                ...
                $.each(allList, function(index, value) {
                    ...
                    draggAbleMenuWrap.append('<li class="dd-item" data-uniqueid="' + oldRandomId +
                        ...
                        '<p><?php echo e(__('loading items')); ?>...</p>' +
                        '</div>' +
                        '</li>');
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\pages\category_menu\menu-edit.blade.php ENDPATH**/ ?>