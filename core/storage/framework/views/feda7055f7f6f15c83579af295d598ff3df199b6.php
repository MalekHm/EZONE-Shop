    ...
    <div class="img-box bg-color-off-white">
        ...
        <div class="hover">
            <ul class="product-interaction-list">
                ...
                <li>
                    <a href="#1" data-id="<?php echo e($item->id); ?>" class="add_to_compare_ajax"> <i class="las la-retweet icon"></i></a>
                </li>
                <li>
                    <?php if(isset($attributes) && $attributes > 0): ?>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\frontend\product\product-card-04.blade.php ENDPATH**/ ?>