<script>
    ...
    $(document).on("submit", ".change-product-image-form", function (e) {
        ...
        send_ajax_request("POST", formData, "<?php echo e($route ?? route('admin.products.update-image')); ?>", function () {
        }, (response) => {
            // does success action
...
</script><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/Product\Resources/views/components/product-image-js.blade.php ENDPATH**/ ?>