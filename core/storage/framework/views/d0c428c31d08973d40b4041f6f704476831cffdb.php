...
<?php endif; ?>
                    <div class="dashboard__card">
                        <div class="dashboard__card__header">
                            <h4 class="dashboard__card__title"><?php echo e(__('Checkout Page Settings')); ?></h4>
                        </div>
                        <div class="dashboard__card__body custom__form mt-4">
                            <form action="<?php echo e(route('admin.page.settings.checkout')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="chekout__items mt-4">
                                    <h6 class="chekout__items__title"><?php echo e(__('Empty checkout page')); ?></h6>
                                    <div class="row g-4">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="checkout_page_no_product_text"><?php echo e(__('Checkout page no product text')); ?></label>
                                ...
                                <div class="chekout__items mt-4">
                                    <h6 class="chekout__items__title"><?php echo e(__('Login Section')); ?></h6>
                                    <div class="row g-4">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="checkout_forgot_password"><?php echo e(__('Checkout forgot password')); ?></label>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="checkout_login_btn_text"><?php echo e(__('Checkout login button text')); ?></label>
                                ...
                                <div class="chekout__items mt-4">
                                    <h6 class="chekout__items__title"><?php echo e(__('Coupon Section')); ?></h6>
                                    <div class="row g-4">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="have_coupon_text"><?php echo e(__('Have coupon text')); ?></label>
                                                <input type="text" class="form-control" id="have_coupon_text"
                                                    name="have_coupon_text"
                                                    value="<?php echo e(get_static_option('have_coupon_text')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="apply_coupon_btn_text"><?php echo e(__('Apply coupon button text')); ?></label>
                                ...
                                <div class="chekout__items mt-4">
                                    <h6 class="chekout__items__title"><?php echo e(__('Billing Info Section')); ?></h6>
                                    <div class="row g-4">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="checkout_billing_section_title"><?php echo e(__('Checkout billing title')); ?></label>
                                                <input type="text" class="form-control"
                                                    id="checkout_billing_section_title" name="checkout_billing_section_title"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="checkout_billing_zipcode"><?php echo e(__('Checkout billing zipcode')); ?></label>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="checkout_billing_address"><?php echo e(__('Checkout billing address')); ?></label>
                                ...
                                <div class="chekout__items mt-4">
                                    <h6 class="chekout__items__title"><?php echo e(__('Create Account Section')); ?></h6>
                                    <div class="row g-4">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="create_account_username"><?php echo e(__('Create account username')); ?></label>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="create_account_password"><?php echo e(__('Create account password')); ?></label>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="create_account_confirmed_password"><?php echo e(__('Create account confirmed password')); ?></label>
                                                <input type="text" class="form-control"
                                                    id="create_account_confirmed_password"
                                ...
                                <div class="chekout__items mt-4">
                                    <h6 class="chekout__items__title"><?php echo e(__('Shipping Address Section')); ?></h6>
                                    <div class="row g-4">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="shipping_name"
                                                    name="shipping_name" value="<?php echo e(get_static_option('shipping_name')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="shipping_country"
                                                    ...
                                                    value="<?php echo e(get_static_option('shipping_country')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="shipping_state"
                                                    name="shipping_state" value="<?php echo e(get_static_option('shipping_state')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="shipping_city"
                                                    name="shipping_city" value="<?php echo e(get_static_option('shipping_city')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="shipping_zipcode"
                                                    ...
                                                    value="<?php echo e(get_static_option('shipping_zipcode')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="shipping_address"
                                                    ...
                                                    value="<?php echo e(get_static_option('shipping_address')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="shipping_email"
                                                    name="shipping_email" value="<?php echo e(get_static_option('shipping_email')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="shipping_phone"
                                                    name="shipping_phone" value="<?php echo e(get_static_option('shipping_phone')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="chekout__items mt-4">
                                    <h6 class="chekout__items__title"><?php echo e(__('Order Summary Section')); ?></h6>
                                    <div class="row g-4">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="subtotal_text"
                                                    name="subtotal_text" value="<?php echo e(get_static_option('subtotal_text')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="discount_text"><?php echo e(__('Discount text')); ?></label>
                                                <input type="text" class="form-control" id="discount_text"
                                                    name="discount_text" value="<?php echo e(get_static_option('discount_text')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="shipping_text"
                                                    name="shipping_text" value="<?php echo e(get_static_option('shipping_text')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="checkout_page_terms_text"><?php echo e(__('Checkout page terms text')); ?></label>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="checkout_page_terms_link_url"><?php echo e(__('Checkout page terms link url')); ?></label>
                                                <select name="checkout_page_terms_link_url" id="checkout_page_terms_link_url"
                                                    ...
                                                    <?php $__currentLoopData = $all_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($page->slug); ?>"
                                                            <?php if($page->slug == get_static_option('checkout_page_terms_link_url')): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\settings\checkout.blade.php ENDPATH**/ ?>