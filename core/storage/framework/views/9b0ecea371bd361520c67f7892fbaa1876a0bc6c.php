...
<?php endif; ?>
                            ...
                            <button type="submit" id="submit"
                                class="cmn_btn btn_bg_profile"><?php echo e(__('Submit')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\pages\page_bckp\new.blade.php ENDPATH**/ ?>