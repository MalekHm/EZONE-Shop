...
<?php endif; ?>
                    <div class="dashboard__card">
                        <div class="dashboard__card__header">
                            <h4 class="dashboard__card__title"><?php echo e(__('Login/Register Page Settings')); ?></h4>
                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="toc_page_link" name="toc_page_link">
                                                <option value=""><?php echo e(__("Select Terms and condition page")); ?></option>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="privacy_policy_link"
                                                ...
                                                <option value=""><?php echo e(__("Select privacy policy page")); ?></option>
                                                <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($page->slug); ?>"><?php echo e($page->title); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
        ...
        <script>
            (function($) {
                ...
                $(document).ready(function() {
                    $("#toc_page_link").val("<?php echo e(get_static_option('toc_page_link')); ?>");
                    $("#privacy_policy_link").val("<?php echo e(get_static_option('privacy_policy_link')); ?>");
                });
            })(jQuery)
        </script>
    <?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\settings\userAuth.blade.php ENDPATH**/ ?>