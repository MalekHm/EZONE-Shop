...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Update mobile terms and condition page')); ?></h4>
                    </div>
                                ...
                                <select id="products" name="page" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>"
                                            <?php echo e(get_static_option('mobile_terms_and_condition') == $item->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/MobileApp\Resources/views/mobile-controller/terms_and_condition.blade.php ENDPATH**/ ?>