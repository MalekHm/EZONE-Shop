...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('All Admin Roles')); ?></h4>
                        <div class="btn-wrapper">
                            <a href="<?php echo e(route('admin.role.new')); ?>" class="cmn_btn btn_bg_profile"><?php echo e(__('New Role')); ?></a>
                        </div>
                    </div>
...
<?php endif; ?>
                                                <?php else: ?>
                                                    <span
                                                        class="alert alert-warning text-capitalize"><?php echo e(__('super admin has all access')); ?></span>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\admin-role-manage\role\index.blade.php ENDPATH**/ ?>