                    ...
                    <nav class="navbar navbar-area nav-style-03 side-menu">
                        <div class="container nav-container max-width-with-padding-1318">
                            <div class="responsive-mobile-menu">
                                <button class="navbar-toggler <?php if(request()->routeIs('homepage')): ?> collapsed <?php endif; ?>" type="button" data-bs-toggle="collapse"
                            ...
                            ?>
                            <div class="navbar-collapse mobile-style collapse <?php echo e($dropdown_status); ?>"
                                id="bizcoxx_main_menu_two">
                                <ul class="navbar-nav">
                    ...
                    <div class="container nav-container max-width-with-padding-1318">
                        <div class="responsive-mobile-menu">
                            ...
                            <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#bizcoxx_main_menu" aria-expanded="false"
                                    aria-label="Toggle navigation">
