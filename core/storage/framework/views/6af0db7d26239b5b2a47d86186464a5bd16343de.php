                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="upload_files" role="tabpanel">
                        <div class="dropzone-form-wrapper">
                            <form action="<?php echo e(route($type . '.upload.media.file')); ?>" method="post" id="placeholderfForm"
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\partials\media-upload\media-upload-markup.blade.php ENDPATH**/ ?>