...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Maintain Page Settings')); ?></h4>
                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="maintain_page_title"
                                            value="<?php echo e(get_static_option('maintain_page_title')); ?>"
                                            name="maintain_page_title" placeholder="<?php echo e(__('Title')); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="maintain_page_description" id="maintain_page_description" class="form-control max-height-150"
                                            cols="30" rows="10"><?php echo e(get_static_option('maintain_page_description')); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control flatpickr" id="maintain_page_datepicker"
                                            value="<?php echo e(get_static_option('maintain_page_datepicker')); ?>"
                                            name="maintain_page_datepicker" placeholder="<?php echo e(__('Date')); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <small
                                            class="form-text text-muted"><?php echo e(__('allowed image format: jpg,jpeg,png. Recommended image size 300x100')); ?></small>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label
                                            for="maintain_page_background_image"><strong><?php echo e(__('Background Image')); ?></strong></label>
                                        <div class="media-upload-btn-wrapper">
                                            <div class="img-wrap">
                                                <?php
                                            ...
                                            <button type="button" class="btn btn-info media_upload_form_btn"
                                                ...
                                                data-modaltitle="<?php echo e(__('Upload Background Image')); ?>" data-bs-toggle="modal"
                                                data-bs-target="#media_upload_modal">
                                        ...
                                        <small
                                            class="form-text text-muted"><?php echo e(__('allowed image format: jpg,jpeg,png. Recommended image size 1920x1000')); ?></small>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <button type="submit"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\pages\maintain-page\maintain-page.blade.php ENDPATH**/ ?>