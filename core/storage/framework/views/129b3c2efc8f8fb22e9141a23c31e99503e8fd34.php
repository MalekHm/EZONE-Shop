...
<?php $__env->startSection('content'); ?>
    ...
    <div class="shop-details-area-wrapper">
        <div class="container">
            <div class="row g-4 <?php if(is_null($sidebar_status) && $sidebar_position == 'right'): ?> flex-row-reverse <?php endif; ?>">
                                        ...
                                        <div class="single-main-image">
                                            ...
                                            <a href="#1" class="long-img">
                                                <figure class="zoom zoom-js-handle"
                                                    data-src="<?php echo e(render_image($product->image, 'full')['img_url']); ?>">
                                                    <div class="product-view-tags">
                                                        <?php if(!empty($product->badge)): ?>
                                                            <span class="badge-tag"><?php echo e($product->badge); ?></span>
                                                        <?php endif; ?>
                                                        <?php if(!empty($campaign_percentage)): ?>
                                                            <span
                                                                class="discount-tag"><?php echo e(round($campaign_percentage, 0)); ?>%</span>
                                                        <?php endif; ?>
                                                    </div>
                                                ...
                                                <?php $__currentLoopData = $product_image_gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="single-thumb">
                                                        <a class="thumb-link individual_thumb_image_wrap"
                                                            data-bs-toggle="tab" href="#image-0<?php echo e($loop->iteration + 1); ?>">
                                                            <?php echo render_image_markup_by_attachment_id($gallery_image, 'img-fluid', 'full', false); ?>
                            ...
                            <div class="col-lg-6 pl-4">
                                ...
                                <div class="product-summery">
                                    ...
                                    <span class="product-meta">
                                        <?php echo e($product->uom?->quantity); ?> <?php echo e($product->uom?->unit?->name); ?>
                                                        ...
                                                        <div class="single-checkbox-wrap attribute">
                                                            <label>
                                                                <input type="radio" name="attr_<?php echo e($attribute['name']); ?>"
                                                                    data-attr="<?php echo e(json_encode($term)); ?>" class="checkbox">
                                    ...
                                    <div class="price-wrap">
                                        <span class="price" data-main-price="<?php echo e($sale_price); ?>"
                                            data-currency-symbol="<?php echo e(site_currency_symbol()); ?>" id="price">
                                            <?php echo e(float_amount_with_currency_symbol($sale_price)); ?>

                                        </span>
                                        <del
                                            class="del-price"><?php echo e(float_amount_with_currency_symbol($deleted_price)); ?></del>
                                    </div>
                                            ...
                                            <ul class="size-lists" data-type="<?php echo e($attribute); ?>">
                                                <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li class="" data-value="<?php echo e($option); ?>"
                                                        data-display-value="<?php echo e($option); ?>"> <?php echo e($option); ?>
                                    ...
                                    <?php if($product->category && $product->category->id): ?>
                                        <div class="category">
                                            <a
                                                href="<?php echo e(route('frontend.products.category', [
                                                            ...
                                                            <div class="col-sm-6 ">
                                                                <form action="<?php echo e(route('user.login')); ?>" method="post"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group col-12">
                                                                            <label
                                                                                for="login_password"><?php echo e(__('Password')); ?>
                                                                    ...
                                                                    <div class="single-comment-wrap">
                                                                        ...
                                                                        <div class="content">
                                                                            <div class="content-top">
                                                                                <div class="left">
                                                                                    <h4 class="title">
                                                                                        <?php echo e(optional($rating->user)->name); ?>
                                                                            ...
                                                                            <p class="comment"><?php echo e($rating->review_msg); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.product.product-card-03','data' => ['product' => $related_product,'model' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <h4 class="text-center py-4"><?php echo e(__('No product found!')); ?></h4>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    if (validateSelectedAttributes()) {
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                setTimeout(function() {
                                    location.href =
                                        '<?php echo e(route('frontend.checkout')); ?>';
                                }, 1000);
                                // refreshShippingDropdown();
                            },
                            erorr: function(err) {
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\product\details.blade.php ENDPATH**/ ?>