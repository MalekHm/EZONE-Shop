                                                ...
                                                <td class="price-td" data-label="Name">
                                                    <div class="vendorList__item">
                                                        ...
                                                        <span class="vendorList__value vendor-value">
                                                            <?php echo e($vendor->owner_name); ?></span>
                                                    </div>
                                                    <div class="vendorList__item">
                                                        ...
                                                        <span class="vendorList__value vendor-value">
                                                            <?php echo e($vendor->vendor_shop_info?->email); ?></span>
                                                    </div>
                                                    <div class="vendorList__item">
                                                        <span
                                                        ...
                                                        <span class="vendorList__value vendor-value">
                                                            <?php echo e($vendor->business_type?->name); ?></span>
                                                    </div>
                                                </td>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/Vendor\Resources/views/backend/index.blade.php ENDPATH**/ ?>