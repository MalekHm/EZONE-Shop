    ...
    <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="cost-name-amount">
            <span class="same sub"><?php echo e($product->title . $item_attributes); ?>
                ...
                <span class="details">
                    <?php echo e($cart_item['quantity']); ?> <?php echo e(__('PCS')); ?> * <?php echo e(float_amount_with_currency_symbol($price)); ?>

                </span>
            </span>
            <span class="same sub-amount">
                <?php echo e(float_amount_with_currency_symbol($price * $cart_item['quantity'])); ?>
...
<div class="sum-bar"></div>
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\cart\checkout-partial.blade.php ENDPATH**/ ?>