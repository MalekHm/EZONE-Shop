<script>
    ;(function () {
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('media-upload-loadmore')): ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('media-upload-alt')): ?>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views/backend/partials/media-upload/media-js.blade.php ENDPATH**/ ?>