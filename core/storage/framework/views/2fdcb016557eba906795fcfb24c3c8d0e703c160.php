...
<?php $__env->startSection('content'); ?>
    <div class="blog-details-area-wrapper padding-top-100 padding-bottom-50">
        <div class="container">
            <div class="row row-reverse justify-content-around">
                <div class="col-xxl-9 col-lg-8">
                    <div class="blog-details-area-inner">
                        ...
                        <div class="content">
                            ...
                            <div class="post-meta">
                                <ul class="post-meta-list">
                                    ...
                                    <li class="post-meta-item">
                                        <a
                                            href="<?php echo e(route('frontend.blog.category', ['id' => optional($blog_post->category)->id, 'name' => optional($blog_post->category)->title]) ?? ''); ?>">
                        ...
                        <div class="blog-details-tag-and-social-link mt-5">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\pages\blog\blog-single.blade.php ENDPATH**/ ?>