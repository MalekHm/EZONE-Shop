    ...
    <div class="product-content">
        <div class="main-content">
            ...
            <div class="product-meta">
                <span class="product-meta"><?php echo e(amount_with_currency_symbol($sale_price)); ?> / <?php echo e($product->uom?->quantity); ?> <?php echo e($product->uom?->unit?->name); ?></span>
            </div>
            ...
            <div class="btn-and-quick-key">
                ...
                <div class="quick-key">
                    <ul class="quick-key-list">
                        ...
                        <li>
                            <?php if(isset($attributes) && $attributes > 0): ?>
                                <a class="product-quick-view-ajax" href="#1" data-action-route="<?php echo e(route('frontend.products.single-quick-view', $product->slug)); ?>">
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\frontend\product\product-list.blade.php ENDPATH**/ ?>