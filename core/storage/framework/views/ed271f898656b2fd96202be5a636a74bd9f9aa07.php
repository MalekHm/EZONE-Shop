...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Edit Form')); ?></h4>
                        <div class="dashboard__card__header__right">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('form-builder-custom-all')): ?>
                                <a href="<?php echo e(route('admin.form.builder.all')); ?>"
                                    class="cmn_btn btn_bg_profile"><?php echo e(__('All Form')); ?></a>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('form-builder-custom-new')): ?>
                                <a href="#1" data-bs-toggle="modal" data-bs-target="#create_new_custom_form"
                                    class="cmn_btn btn_bg_2">
                                    <?php echo e(__('New Form')); ?>
                    ...
                    <div class="dashboard__card__body custom__form mt-4">
                        <form action="<?php echo e(route('admin.form.builder.update')); ?>" method="Post">
                            ...
                            <div class="form-group">
                                ...
                                <span
                                    class="info-text"><?php echo e(__('your will get mail with all info of from to this email')); ?></span>
                            </div>
                            <div class="form-group">
                                <label for="text"><?php echo e(__('Button Title')); ?></label>
                                <input type="text" class="form-control" name="button_title"
                                    value="<?php echo e($form->button_text); ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" class="cmn_btn btn_bg_profile"><?php echo e(__('Save Change')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Available Form Fields')); ?></h4>
                    </div>
                    ...
                    <form action="<?php echo e(route('admin.form.builder.store')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="text"><?php echo e(__('Button Title')); ?></label>
                                <input type="text" class="form-control" name="button_title"
                                    placeholder="<?php echo e(__('Enter Button Title')); ?>">
                            </div>
                            <div class="form-group">
                                <label for="success_message"><?php echo e(__('Success Message')); ?></label>
                                <input type="text" class="form-control" name="success_message"
                                    placeholder="<?php echo e(__('form submit success message')); ?>">
                            </div>
                        </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\form-builder\custom\edit.blade.php ENDPATH**/ ?>