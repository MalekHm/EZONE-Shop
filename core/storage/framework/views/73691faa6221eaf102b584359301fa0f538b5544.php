<script>
    $(document).on("change", ".shipping-methods-radio", function (){
        $("#shipping_charge").html("<?php echo e(site_currency_symbol()); ?>" + $(this).val());
                ...
                if (method !== undefined) {
                    this.label += `<label class="order-shipping-methods-item">
                        ...
                        <div class="order-shipping-methods-item-right">
                            <h6 class="order-shipping-methods-price">${"<?php echo e(site_currency_symbol()); ?>" +  method.cost}</h6>
                        </div>
                    </label>`;
                }
...
</script><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/ShippingModule\Resources/views/frontend/shipping-charge.blade.php ENDPATH**/ ?>