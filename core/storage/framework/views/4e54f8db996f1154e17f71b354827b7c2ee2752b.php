                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <div class="dashboard__card__header__left">
                            <h4 class="dashboard__card__title"><?php echo e(__('Custom Css')); ?></h4>
                            <p class="dashboard__card__para mt-2">
                                <?php echo e(__('you can only add css style here. no other code work here.')); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\general-settings\custom-css.blade.php ENDPATH**/ ?>