                ...
                <div class="download-left-contents bg-item-two radius-10">
                    <div class="download-wrapper--flex">
                        <div class="download-contents">
                            <span class="span-title fw-500 color-light mb-3 mb-lg-4"><?php echo e($sub_title); ?></span>
                            <h2 class="download-title fw-500"> <a href="<?php echo e($url); ?>"> <?php echo e($title); ?> </a>
                            </h2>
                        ...
                        <div class="download-mobile-img">
                            <?php echo render_image_markup_by_attachment_id($left_image); ?>

                            <?php echo render_image_markup_by_attachment_id($right_image); ?>
...
<!-- Download area end -->
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\app\Providers/../PageBuilder/views/banners/style-06.blade.php ENDPATH**/ ?>