            ...
            <div class="col-12">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('All Admin Created By Super Admin')); ?></h4>
                    </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $all_user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if(!empty($img)): ?>
                                                    <div class="attachment-preview">
                                                        <div class="thumbnail">
                                                            <div class="centered">
                                                                <img class="avatar user-thumb" src="<?php echo e($img['img_url']); ?>"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-delete-user')): ?>
...
<?php endif; ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-user-edit')): ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-user-password-change')): ?>
                                                    <a href="#1" data-id="<?php echo e($data->id); ?>" data-bs-toggle="modal"
        ...
        <div class="modal fade" id="user_change_password_modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content custom__form">
                    ...
                    <?php echo $__env->make('backend/partials/error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <form action="<?php echo e(route('admin.user.password.change')); ?>" id="user_password_change_modal_form"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/AdminManage\Resources/views/backend/all-user.blade.php ENDPATH**/ ?>