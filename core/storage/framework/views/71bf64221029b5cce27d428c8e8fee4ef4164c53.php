                    ...
                    <div class="col-xxl-4 col-md-5">
                        <div class="order__item__estimate">
                            <div class="order__item__estimate__single d-flex justify-content-between">
                                ...
                                <strong id="vendor_subtotal"><?php echo e(float_amount_with_currency_symbol(2600)); ?></strong>
                            </div>
                            <div class="order__item__estimate__single d-flex justify-content-between">
                                <span><?php echo e(__('Tax Amount')); ?></span>
                                <strong id="vendor_tax_amount"><?php echo e(float_amount_with_currency_symbol(170)); ?></strong>
                            </div>
                            <div class="order__item__estimate__single d-flex justify-content-between">
                                <span><?php echo e(__('Shipping Cost')); ?></span>
                                <strong id="vendor_shipping_cost"><?php echo e(float_amount_with_currency_symbol(200)); ?></strong>
                            </div>
                            <div class="order__item__estimate__single d-flex justify-content-between">
                                <span><?php echo e(__('Total')); ?></span>
                                <strong id="vendor_total"><?php echo e(float_amount_with_currency_symbol(2800)); ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="custom__form">
                    <div class="order__refund__item mt-5">
                        ...
                        <div class="order__refund__item__available mt-4">
                            <?php $__currentLoopData = $refundable_items ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\user\dashboard\order\refund.blade.php ENDPATH**/ ?>