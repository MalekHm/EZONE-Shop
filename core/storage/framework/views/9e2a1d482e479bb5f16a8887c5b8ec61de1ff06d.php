    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $('.attribute input[type=radio]').on('click', function () {
                ...
                $('#price').text(site_currency_symbol + parseFloat(new_price).toFixed(0));
            });
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\partials\scripts\footer-scripts.blade.php ENDPATH**/ ?>