            ...
            <div class="col-lg-7">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Contact Info Items')); ?></h4>
...
<?php endif; ?>
                                            ...
                                            class="btn btn-lg btn-primary btn-sm mb-2 me-1 contact_info_edit_btn"
            ...
            <div class="col-lg-5">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('New Contact Info')); ?></h4>
                    </div>
                    <div class="dashboard__card__body custom__form mt-4">
                        <form action="<?php echo e(route('admin.contact.info')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <button id="submit" type="submit" class="cmn_btn btn_bg_profile"><?php echo e(__('Add Contact Info Item')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\pages\contact-page\contact-info.blade.php ENDPATH**/ ?>