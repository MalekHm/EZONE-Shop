            ...
            <div class="col-12">
                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Payment Report')); ?></h4>
                    </div>
                    <div class="dashboard__card__body custom__form mt-4">
                        <form action="<?php echo e(route('admin.payment.report')); ?>" method="get" enctype="multipart/form-data"
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <select name="payment_status" id="order_status" class="form-control">
                                            ...
                                            <option <?php if($payment_status == 'pending'): ?> selected <?php endif; ?> value="pending">
                                                <?php echo e(__('Pending')); ?></option>
                                            <option <?php if($payment_status == 'complete'): ?> selected <?php endif; ?> value="complete">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <select name="items" id="items" class="form-control">
                                            <option <?php if($items == '10'): ?> selected <?php endif; ?> value="10">
                                                <?php echo e(__('10')); ?></option>
                                            <option <?php if($items == '20'): ?> selected <?php endif; ?> value="20">
                                                <?php echo e(__('20')); ?></option>
                                            <option <?php if($items == '50'): ?> selected <?php endif; ?> value="50">
                                                <?php echo e(__('50')); ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $order_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><strong><?php echo e(ucwords(str_replace('_', ' ', $data->package_gateway))); ?></strong>
                                                    </td>
                                                    <td>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\payment-logs\payment-report.blade.php ENDPATH**/ ?>