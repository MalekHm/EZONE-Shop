...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('Edit Shipping Method')); ?></h4>
                    ...
                    <div class="dashboard__card__body custom__form mt-4">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('shipping-method-edit')): ?>
                            <form action="<?php echo e(route('admin.shipping.method.update')); ?>" method="post"
                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            <select name="zone_id" id="zone_id" class="form-control"
                                                ...
                                                <?php $__currentLoopData = $all_zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($zone->id); ?>"
                                                        <?php if($item->zone_id == $zone->id): ?> selected <?php endif; ?>><?php echo e($zone->name); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control"
                                                placeholder="<?php echo e(__('Title')); ?>" value="<?php echo e($item->name); ?>">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="tax_status" id="tax_status" class="form-control">
                                                <?php $__currentLoopData = $all_tax_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tax_status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>"
                                                        <?php if(optional($item->options)->tax_status == $key): ?> selected <?php endif; ?>><?php echo e($tax_status); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control">
                                                <?php $__currentLoopData = $all_publish_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>"
                                                        <?php if(optional($item->options)->status == $key): ?> selected <?php endif; ?>><?php echo e($status); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="setting_preset" id="setting_preset" class="form-control">
                                                <?php $__currentLoopData = $all_setting_presets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>"
                                                        <?php if(optional($item->options)->setting_preset == $key): ?> selected <?php endif; ?>><?php echo e($value); ?>
                                        ...
                                        <div class="form-group"
                                            style="<?php echo e(optional($item->options)->setting_preset != 'none' ? '' : 'display: none'); ?>">
                                            ...
                                            <input type="number" id="minimum_order_amount" name="minimum_order_amount"
                                                ...
                                                value="<?php echo e(optional($item->options)->minimum_order_amount); ?>">
                                        </div>
                                            ...
                                            <select name="coupon_code" id="coupon_code" class="form-control">
                                                ...
                                                <?php $__currentLoopData = $all_coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($coupon->code); ?>"
                                                        <?php echo e($coupon->code === optional($item->options)->coupon ? 'selected' : ''); ?>>
                                                        <?php echo e($coupon->code); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="cost" name="cost" class="form-control"
                                                ...
                                                value="<?php echo e(optional($item->options)->cost); ?>">
                                        </div>
                                        <button type="submit"
                                            class="btn btn-primary my-4 px-4"><?php echo e(__('Update Shipping Method')); ?></button>
                                    </div>
                                </div>
                            </form>
                        <?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\shipping\method\edit.blade.php ENDPATH**/ ?>