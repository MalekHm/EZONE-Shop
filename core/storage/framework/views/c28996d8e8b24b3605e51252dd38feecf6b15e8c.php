                            ...
                            <div class="user-dahsboard-order-info-wrap">
                                ...
                                <?php if(!empty($data->event) && $data->payment_status == 'complete'): ?>
                                    <form action="<?php echo e(route('frontend.event.invoice.generate')); ?>"  method="post">
                                        ...
                                        <button class="btn btn-sm btn-secondary" type="submit"><?php echo e(__('Invoice')); ?></button>
                                    </form>
                                <?php endif; ?>
                            </div>
                        </td>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\user\dashboard\event-booking.blade.php ENDPATH**/ ?>