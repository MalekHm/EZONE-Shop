...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('All Pages')); ?></h4>
                        <div class="dashboard__card__header__right">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page-bulk-action')): ?>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page-new')): ?>
                                <div class="btn-wrapper">
                                    <a href="<?php echo e(route('admin.page.new')); ?>"
                                        class="cmn_btn btn_bg_profile"><?php echo e(__('Add New Page')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $all_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page-bulk-action')): ?>
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.td','data' => ['id' => $page->id]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                                            ...
                                            <td>
                                                <?php if(empty($dynamic_page_ids[$page->id])): ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page-delete')): ?>
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover','data' => ['url' => route('admin.page.delete', $page->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page-builder-dynamic-page')): ?>
                                                    <?php if(!empty($page->page_builder_status)): ?>
                                                        <a href="<?php echo e(route('admin.dynamic.page.builder', ['type' => 'dynamic-page', 'id' => $page->id])); ?>" target="_blank" class="btn btn-xs btn-secondary mb-2 me-1">
...
<?php endif; ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('page-bulk-action')): ?>
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.js','data' => ['route' => route('admin.page.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views/backend/pages/page/index.blade.php ENDPATH**/ ?>