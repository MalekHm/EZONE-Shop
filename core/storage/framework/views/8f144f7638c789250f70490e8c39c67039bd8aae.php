        ...
        <div class="search-inner">
            ...
            <div class="product-suggestion item-suggestions">
                <h6 class="item-title d-flex justify-content-between">
                    ...
                    <a href="#1" target="_blank" id="search_result_all" class="showAll"><?php echo e(__('Show all')); ?></a>
                </h6>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\partials\search-result.blade.php ENDPATH**/ ?>