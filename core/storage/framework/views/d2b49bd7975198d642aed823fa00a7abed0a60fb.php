<script>
    ...
    (function (){
        ...
        $(document).on('change','#state_id', function() {
            ...
            $.get('<?php echo e(route('state.info.ajax')); ?>', {id: id}).then(function(data) {
                $('#tax_amount').attr('tax-percentage', Number(data.tax_percentage));
        ...
        $(document).on('change','#country_id', function() {
            ...
            $.get('<?php echo e(route('country.info.ajax')); ?>', {id: id}).then(function(data) {
                ...
                $('#tax_amount').text(site_currency_symbol + Number(data.tax).toFixed(0));
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.type == 'success') {
                    ...
                    $('#coupon_amount').text("<?php echo e(site_currency_symbol()); ?>" + data.coupon_amount);
    ...
    function calculateTotal() {
        ...
        let tax_amount = subtotal * Number($('#tax_amount').text().trim().replace(site_currency_symbol, '')) / 100;
        ...
        $('#total_amount').text(site_currency_symbol + total_amount.toFixed(0));
...
</script><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\partials\scripts\checkout-scripts.blade.php ENDPATH**/ ?>