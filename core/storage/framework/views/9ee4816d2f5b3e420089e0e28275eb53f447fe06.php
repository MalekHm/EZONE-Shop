                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="upload_files" role="tabpanel">
                        <div class="dropzone-form-wrapper">
                            <form action="<?php echo e(route($type . '.upload.media.file')); ?>" method="post"
                                ...
                                <div class="media-uploader-image-info">
                                    ...
                                    <div class="img-info">
                                            ...
                                            <li class="imgalt">
                                                <div class="img-alt-wrap">
                                                    ...
                                                    <button class="btn btn-success img_alt_submit_btn">
                                                        <i
                                                            class="<?php if($type === 'admin'): ?> fas fa-check <?php else: ?> las la-check <?php endif; ?>"></i>
                                                    </button>
                                                </div>
                                            </li>
                                        </ul>
                                        <a tabindex="0" style="display: none"
                                            ...
                                            data-type="<?php echo e($type); ?>" role="button">
                                            <i
                                                class="<?php if($type === 'admin'): ?> fas fa-trash <?php else: ?> las la-trash <?php endif; ?>"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\media\old\markup.blade.php ENDPATH**/ ?>