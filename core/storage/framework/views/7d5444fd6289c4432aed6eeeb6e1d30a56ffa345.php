...
>
    <div class="before-hover btn btn-outline-secondary">
        <?php echo e($shipping_address->shipping_address_name); ?>
    ...
    <div class="after-hover position-absolute top-0 bg-color-one text-light d-none">
        ...
        <p><?php echo e(__("City")); ?>: <b><?php echo e($shipping_address->city); ?></b></p>
        <p><?php echo e(__("Mobile")); ?>: <b><?php echo e($shipping_address->phone); ?></b></p>
    </div>
</div><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\cart\partials\shipping-address-option.blade.php ENDPATH**/ ?>