                ...
                <div class="widget-area-wrapper">
                    ...
                    <div class="widget widget-tag">
                        ...
                        <div class="tag">
                            ...
                            <a href="#1" class="tag-btn <?php if(request()->t == $tag->tag_text): ?> selected <?php endif; ?>"><?php echo e($tag->tag_text); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\frontend\product\all.blade.php ENDPATH**/ ?>