                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="maintain_page_countdown" class="form-control flatpickr"
                                            value="<?php echo e(get_static_option('maintain_page_countdown')); ?>">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <button type="submit"
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\pages\maintain-page\maintain-page-index.blade.php ENDPATH**/ ?>