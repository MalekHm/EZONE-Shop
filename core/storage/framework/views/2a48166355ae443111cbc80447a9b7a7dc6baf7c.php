    ...
    <div class="login-account">
        ...
        <?php else: ?>
            <a class="accounts" href="#1"><i class="las la-user"></i> <span
                        class="icon-title"><?php echo e(__('Login/Register')); ?></span></a>
            <ul class="account-list-item">
...
</div><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views/frontend/partials/header/navbar/card-and-wishlist-area.blade.php ENDPATH**/ ?>