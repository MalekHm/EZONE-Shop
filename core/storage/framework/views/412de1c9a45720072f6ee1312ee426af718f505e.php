...
<div class="form-group permalink">
    <div class="permalink_top_part d-none">
    ...
    <div class="permalink_bottom_part d-none">
        <input type="text" name="slug" class="form-control permalink_bottom_blog_slug_input_field mt-2" >
        <button class="btn btn-info btn-sm slug_update_button mt-2" ><?php echo e(__('Update')); ?></button>
    </div>
</div>

<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\components\slug\add-markup.blade.php ENDPATH**/ ?>