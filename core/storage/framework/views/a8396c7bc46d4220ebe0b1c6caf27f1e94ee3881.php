...
<?php endif; ?>
                    <div class="dashboard__card">
                        <div class="dashboard__card__header">
                            <h4 class="dashboard__card__title"><?php echo e(__('Product Details Page Settings')); ?></h4>
                        </div>
                            ...
                            <form action="<?php echo e(route('admin.page.settings.product.detail.page')); ?>" method="POST">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label
                                                for="additional_information_text"><?php echo e(__('Additional Information Tab Text')); ?></label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label
                                                for="related_product_text"><?php echo e(__('Related Product Section Title Text')); ?></label>
                                    ...
                                    <?php if(false): ?>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.media-upload','data' => ['name' => 'related_product_image','oldimage' => get_static_option('related_product_image'),'title' => __('Related Product Section Image')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('related_product_image'),'oldimage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(get_static_option('related_product_image')),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Related Product Section Image'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" name="sidebar_status"
                                                    <?php echo e(!empty(get_static_option('sidebar_status')) ? 'checked' : ''); ?>><span
                                                    class="slider"></span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sidebar_position" id="sidebar_position">
                                                <option value="left" <?php if(get_static_option('sidebar_position') == 'left'): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('Left')); ?></option>
                                                <option value="right" <?php if(get_static_option('sidebar_position') == 'right'): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\settings\product-detail-page.blade.php ENDPATH**/ ?>