                ...
                <div class="col-sm-12">
                    <div class="dashboard-input">
                        ...
                        <textarea style="height: 120px" class="form--control form--message  radius-10" name="summery"
                            placeholder="<?php echo e(__('Write product Summery...')); ?>"><?php echo e($product?->summary ?? ''); ?></textarea>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="dashboard-input">
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/Product\Resources/views/components/general-info.blade.php ENDPATH**/ ?>