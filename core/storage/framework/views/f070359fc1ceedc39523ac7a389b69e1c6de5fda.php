        ...
        <div class="single-category-megamenu text-center border-1">
            <ul class="mega-menu-main">
                <li class="round-menu-product">
                    <a href="<?php echo e(route("frontend.products.subcategory",["id" => $item->id,"title" => $item->slug])); ?>">
...
<?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\app\Providers/../MenuBuilder/CategoryMenu/views/style_two_category_menu.blade.php ENDPATH**/ ?>