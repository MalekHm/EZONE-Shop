            ...
            <div class="col-12">
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('New Admin')); ?></h4>
                    </div>
                    <div class="dashboard__card__body custom__form mt-4">
                        <form action="<?php echo e(route('admin.new.user')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="media-upload-btn-wrapper">
                                    ...
                                    <input type="hidden" id="image" name="image"
                                        value="<?php echo e(get_static_option('image')); ?>">
                                    <button type="button" class="cmn_btn btn_bg_profile media_upload_form_btn"
                            ...
                            <button type="submit" class="cmn_btn btn_bg_profile mt-4"><?php echo e(__('Add New Admin')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/AdminManage\Resources/views/backend/add-new-user.blade.php ENDPATH**/ ?>