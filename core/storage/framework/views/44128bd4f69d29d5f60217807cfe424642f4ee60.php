...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e($form_title); ?></h4>
                        <?php if($notice && $notice_type): ?>
                            <div class="alert alert-<?php echo e($notice_type); ?> alert-block ">
                                <strong><i class="ti-hand-point-right mr-1"></i> <?php echo e($notice); ?></strong>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="dashboard__card__body mt-4">
                        <form action="<?php echo e($action); ?>" method="Post"><?php echo csrf_field(); ?>
                            <?php echo render_drag_drop_form_builder_markup($field_name); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\partials\form-builder\draggable-form.blade.php ENDPATH**/ ?>