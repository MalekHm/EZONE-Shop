...
<?php endif; ?>
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title"><?php echo e(__('All Languages')); ?></h4>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="language__list">
                                                    <li><strong class="language__list__strong"><?php echo e('Name'); ?></strong>
                                                        <span class="language__list__span"><?php echo e($data->name); ?></span>
                                                    </li>
                                                    <li><strong class="language__list__strong"><?php echo e('Direction'); ?></strong>
                                                        <span
                                                            class="language__list__span"><?php echo e(strtoupper($data->direction)); ?></span>
                                                    </li>
                                                    <li><strong class="language__list__strong"><?php echo e('Slug'); ?></strong>
                                                        <span
                                                            class="language__list__span"><?php echo e(strtoupper($data->slug)); ?></span>
                                                    </li>
                                                    <li><strong class="language__list__strong"><?php echo e('Status'); ?></strong>
                                                        <span
                                                            class="language__list__span"><?php echo e(strtoupper($data->status)); ?></span>
                                                    </li>
                                                </ul>
                                            </td>
                                            <td>
                                                <?php if($data->default == 1): ?>
                                                    <a href="#1"
                                                        class="btn btn-success btn-sm mb-2 me-1"><?php echo e(__('Default')); ?></a>
                                                <?php else: ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('languages-default')): ?>
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('languages-delete')): ?>
                                                    <?php if($data->default != 1): ?>
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php endif; ?>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('languages-words-backend')): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('languages-words-frontend')): ?>
                                                    <a href="<?php echo e(route('admin.languages.words.frontend', $data->slug)); ?>"
                                                        title="<?php echo e(__('Frontend Words')); ?>"
                                                        class="btn btn-info btn-xs mb-2 me-1 text-white">
                                                        <i class="ti-pencil"></i> <?php echo e(__('Frontend Words')); ?>

                                                    </a>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('languages-words-update')): ?>
                                                    <a href="#1" data-bs-toggle="modal"
                                                        ...
                                                        data-slug="<?php echo e($data->slug); ?>" data-status="<?php echo e($data->status); ?>"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('languages-new')): ?>
                <div class="col-lg-6">
                    <div class="dashboard__card">
                        <div class="dashboard__card__header">
                            <h4 class="dashboard__card__title"><?php echo e(__('Add New Language')); ?></h4>
                        </div>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('languages-update')): ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views/backend/languages/index.blade.php ENDPATH**/ ?>