<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Mobile vendor intros')); ?>
                    ...
                    <div class="dashboard__card__header">
                        ...
                        <div class="btn-wrapper">
                            <a class="cmn_btn btn_bg_profile"
                                href="<?php echo e(route('admin.mobile.vendor.intro.create')); ?>"><?php echo e(__('Create')); ?></a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $mobileIntros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.btn.swal.delete','data' => ['route' => route('admin.mobile.vendor.intro.delete', $slider->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.mobile.vendor.intro.delete', $slider->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                                                ...
                                                <a class="btn btn-primary btn-sm btn-xs mb-2 me-1"
                                                    href="<?php echo e(route('admin.mobile.vendor.intro.edit', $slider->id)); ?>">
                                                    <i class="ti-pencil"></i>
                                                </a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\Modules/MobileApp\Resources/views/intro/vendor/list.blade.php ENDPATH**/ ?>