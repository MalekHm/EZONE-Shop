                ...
                <div class="dashboard__card">
                    ...
                    <div class="dashboard__card__body custom__form mt-4">
                        ...
                        <form action="<?php echo e(route('admin.new.user')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="cmn_btn btn_bg_profile"><?php echo e(__('Add New Admin')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\admin-role-manage\add-new-user.blade.php ENDPATH**/ ?>