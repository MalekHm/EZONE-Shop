                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="og_meta_title" value="<?php echo e($page_post->og_meta_title); ?>"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="meta_description" class="form-control" rows="5" id="meta_description"><?php echo e($page_post->meta_description); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="og_meta_description"><?php echo e(__('OG Meta Description')); ?></label>
                                        <textarea name="og_meta_description" class="form-control" rows="5" id="og_meta_description"><?php echo e($page_post->og_meta_description); ?></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="media-upload-btn-wrapper">
                                            ...
                                            <input type="hidden" id="og_meta_image" name="og_meta_image"
                                                value="<?php echo e($page_post->og_meta_image); ?>">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ESHOP\main-file\core\resources\views\backend\pages\page_bckp\edit.blade.php ENDPATH**/ ?>